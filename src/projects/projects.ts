...
export const DEFAULT_PROJECTS: Project[] = [
    {
        title: "Venue Vendor",
        description:
        "Full-stack venue booking platform with REST and GraphQL APIs, built with a 2-person team.",
        longDescription:
    ...
    },
    {
        title: "Task Manager",
        description:
        "Full-stack task manager with JWT authentication, deployed independently end-to-end.",
        longDescription:
    ...
    },
    {
        title: "EventHub",
        description:
        "Event booking platform with admin dashboard, built in a 6-person Agile team.",
        longDescription:
