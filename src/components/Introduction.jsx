...
function Introduction() {
    return (
        <section>
            <div className="bg-linear-to-t from-slate-200 to-white border border-slate-200 p-8 rounded-2xl shadow-2xl">
                <h1>
                ...
                <p className="pt-4">
                    Download <a href="/Software_Engineer_Resume.pdf" target="_blank" className="text-blue-500 hover:border-b hover:border-blue-500 transition-all duration-300 ease-in-out">Resume</a>
                </p>
            </div>
